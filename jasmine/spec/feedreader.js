...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page?
         */
        it('ensure allFeeds are defined', function() {
         ...
         */
         it('ensure that all feeds objects has URL defined and not empty', function(){
         ...
         */
         it('ensure that all feeds objects has name defined and not empty', function(){
           for(let obj of allFeeds) {
...
describe('The menu' , function(){
    ...
    describe('Initial Entries',function(){
         ...
         */
         ...
         it('ensures there is at least a single entry element when the loadFeed is called',function(done){
